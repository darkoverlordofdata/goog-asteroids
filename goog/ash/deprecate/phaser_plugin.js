goog.provide('ash.deprecate.PhaserPlugin');
...
/*
   ...
   */
  ash.ext.PhaserPlugin = function(game, parent) {
    ...
    ash.ext.PhaserPlugin.superClass_.constructor.call(this, game, parent);
    this.nodes = {};
    this.components = {};
  ...
  goog.inherits(ash.ext.PhaserPlugin, Phaser.Plugin);
  ash.ext.PhaserPlugin.prototype.entityNames = null;
  ash.ext.PhaserPlugin.prototype.entityList = null;
  ash.ext.PhaserPlugin.prototype.systemList = null;
  ash.ext.PhaserPlugin.prototype.families = null;
  ash.ext.PhaserPlugin.prototype.nodes = null;
  ash.ext.PhaserPlugin.prototype.components = null;
  
/*
   * Phaser.Plugin members
   */
  ash.ext.PhaserPlugin.prototype.game = null;
  ash.ext.PhaserPlugin.prototype.parent = null;
  ash.ext.PhaserPlugin.prototype.active = true;
  ash.ext.PhaserPlugin.prototype.visible = true;
  ash.ext.PhaserPlugin.prototype.hasPostRender = true;
  
/*
   * Indicates if the engine is currently in its update loop.
   */
  ash.ext.PhaserPlugin.prototype.updating = false;
...
/*
   ...
   */
  ash.ext.PhaserPlugin.prototype.updateComplete = null;
...
/*
   ...
   */
  ash.ext.PhaserPlugin.prototype.familyClass = ComponentMatchingFamily;
  ash.ext.PhaserPlugin.prototype.addNode = function(name, def) {
  ...
  ash.ext.PhaserPlugin.prototype.init = function(nodes, components) {
...
/*
  ...
  Object.defineProperties(ash.ext.PhaserPlugin.prototype, {
...
/*
   ...
   */
  ash.ext.PhaserPlugin.prototype.addEntity = function(entity) {
...
/*
   ...
   */
  ash.ext.PhaserPlugin.prototype.removeEntity = function(entity) {
    var each, family, _ref;
  ...
  ash.ext.PhaserPlugin.prototype.entityNameChanged = function(entity, oldName) {
...
/*
   ...
   */
  ash.ext.PhaserPlugin.prototype.getEntityByName = function(name) {
...
/*
   ...
   */
  ash.ext.PhaserPlugin.prototype.removeAllEntities = function() {
...
/*
   @private
   */
  ash.ext.PhaserPlugin.prototype.componentAdded = function(entity, componentClass) {
    var each, family, _ref;
    _ref = this.families;
    for (each in _ref) {
      family = _ref[each];
...
/*
   @private
   */
  ash.ext.PhaserPlugin.prototype.componentRemoved = function(entity, componentClass) {
    var each, family, _ref;
    _ref = this.families;
    for (each in _ref) {
      family = _ref[each];
...
/*
   ...
   */
  ash.ext.PhaserPlugin.prototype.getNodeList = function(nodeClass) {
    var entity, family;
...
/*
   ...
   */
  ash.ext.PhaserPlugin.prototype.releaseNodeList = function(nodeClass) {
    if (nodeClass.name in this.families) {
...
/*
   ...
   */
  ash.ext.PhaserPlugin.prototype.addSystem = function(system, priority) {
...
/*
   ...
   */
  ash.ext.PhaserPlugin.prototype.getSystem = function(type) {
...
/*
   ...
   */
  ash.ext.PhaserPlugin.prototype.removeSystem = function(system) {
...
/*
   ...
   */
  ash.ext.PhaserPlugin.prototype.removeAllSystems = function() {
...
/*
   ...
   */
  ash.ext.PhaserPlugin.prototype.update = function() {
    var system, time;
